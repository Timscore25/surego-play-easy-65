    ...
    <footer className="bg-gray-100 pt-12 md:pt-16 pb-6 md:pb-8">
      <div className="app-container px-4 sm:px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mb-10 md:mb-12">
          <div>
            <h3 className="flex items-center justify-start text-base md:text-lg font-bold mb-4">
          ...
          <div>
            <h3 className="flex items-center justify-start text-base md:text-lg font-bold mb-4">{t('support')}</h3>
            <ul className="space-y-2 text-sm md:text-base">
          ...
          <div>
            <h3 className="flex items-center justify-start text-base md:text-lg font-bold mb-4">{t('legal')}</h3>
            <ul className="space-y-2 text-sm md:text-base">
          ...
          <div>
            <h3 className="flex items-center justify-start text-base md:text-lg font-bold mb-4">{t('language')}</h3>
