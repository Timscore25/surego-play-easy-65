      ...
      <div className="app-container">
        <div className="flex flex-col-reverse lg:flex-row items-center lg:space-x-8 px-4 md:px-0">
          ...
          animationDelay: '0.2s'
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-3 sm:gap-4">
              <Button className="py-4 sm:py-6 px-6 sm:px-8 rounded-xl flex items-center gap-2 bg-[#ffc000] text-gray-950">
                <svg className="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="#ffc100">
              ...
              <Button className="py-4 sm:py-6 px-6 sm:px-8 rounded-xl flex items-center gap-2 bg-[ffc100] text-gray-950 bg-[#ffc100]">
                <svg className="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="#ffc100">
          ...
          <div className="w-full lg:w-1/2 flex justify-center">
            <div className="relative w-48 sm:w-64 md:w-72 h-auto animate-float">
