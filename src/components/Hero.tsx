        ...
        <div className="flex flex-col-reverse lg:flex-row items-center lg:space-x-8">
          ...
          animationDelay: '0.2s'
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
              <Button className="py-6 px-8 rounded-xl flex items-center gap-2 text-gray-950 bg-[#ffc100]">
              ...
              <Button className="py-6 px-8 rounded-xl flex items-center gap-2 bg-[#ffc100] text-gray-950">
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
