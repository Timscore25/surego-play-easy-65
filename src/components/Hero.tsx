  ...
  return <section id="hero" className="pt-24 pb-12 md:pt-28 md:pb-16 bg-gradient-to-b from-dbeafe to-white overflow-hidden bg-[#11e7ef]">
      <div className="app-container">
        <div className="flex flex-col-reverse lg:flex-row items-center lg:space-x-8">
          {/* Hero Content */}
          <div className="w-full lg:w-1/2 text-center lg:text-left animate-fade-in" style={{
          animationDelay: '0.2s'
        }}>
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
              <Button className="py-6 px-8 rounded-xl flex items-center gap-2 bg-[#ffc000] text-gray-950">
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#11e7ef">
              ...
              <Button className="py-6 px-8 rounded-xl flex items-center gap-2 bg-[ffc100] text-gray-950 bg-[#ffc100]">
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#11e7ef">
