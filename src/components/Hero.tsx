...
const Hero = () => {
  return (
    <section id="hero" className="pt-28 pb-16 md:pt-32 md:pb-24 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
              <Button className="bg-black hover:bg-gray-800 text-white py-6 px-8 rounded-xl flex items-center gap-2">
          ...
          <div className="w-full lg:w-1/2 mb-8 lg:mb-0 flex justify-center">
            <div className="relative w-64 md:w-80 h-auto animate-float">
              <div className="absolute inset-0 bg-gradient-to-b from-surego-500/20 to-surego-600/30 rounded-[2.5rem] transform rotate-6"></div>
