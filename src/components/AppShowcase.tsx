const AppShowcase = () => {
  ...
  return <section id="app-showcase" className="relative section-padding bg-gradient-to-b from-dbeafe to-white pt-24">
      {/* Wave SVG at the top */}
      <div className="absolute top-0 left-0 right-0 w-full overflow-hidden -mt-1 line-height-0">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-16 md:h-24 bg-slate-50">
          <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" fill="#ffc100"></path>
        </svg>
      </div>
      ...
      <div className="app-container">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 mt-10 md:mt-12">
          {screenshots.map((screenshot, index) => <div key={index} className="relative w-64 h-auto animate-fade-in" style={{
