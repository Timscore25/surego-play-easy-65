    ...
    <section id="testimonials" className="section-padding bg-primary text-white">
      <div className="app-container">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            <CardContent className="p-8">
              <div className="flex flex-col h-full">
                <div className="flex items-center mb-6">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <Star key={star} className="h-6 w-auto text-warmyellow-400" fill="currentColor" />
                  ))}
                </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 shadow-lg animate-fade-in md:col-span-2" style={{ animationDelay: '0.6s' }}>
